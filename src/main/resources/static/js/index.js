...
layui.config({
    ...
    tab = layui.bodyTab({
        ...
        url: base+"/json/navs.json" //获取菜单json地址
    });
    ...
    function lockPage() {
        layer.open({
            ...
            '<div class="admin-header-lock-name" id="lockUserName">欢迎回来</div>' +
            '<div class="input_btn">' +
    ...
    $("body").on("click", "#unlock", function () {
        if ($(this).siblings(".admin-header-lock-input").val() == '') {
            ...
            if ($(this).siblings(".admin-header-lock-input").val() == "123") {
...
function donation() {
    layer.tab({
        ...
        tab: [{
            title: "微信",
            content: "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='${ctxPath}/images/wechat.jpg'></div>"
        }, {
            title: "支付宝",
            content: "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='${ctxPath}/images/alipay.jpg'></div>"
        }]
    })
}
